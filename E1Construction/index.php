...
<section class="gray-bg">
  <div class="container">
    <div class="section-header text-center"><br>
      <h2>Find the Best <span>HeavyDutyVehicle For You</span></h2>
      <p>In this system we provide Heavy duty vehical like Backhoe Loader, Crane, Bulldozer, Boom lift, Excavator, Skid Steer Loader, Driller, etc…
      </p>
      <p>In This System provide hourly or daily bases vechical on rantels.</p><br>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New HeavyDuty Vehicle</a></li>
        </ul>
      </div>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="" aria-hidden="true"></i>500+</h2>
            <p>Heavy Machinary For Rentals</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="" aria-hidden="true"></i>700+</h2>
            <p>Providing Services to User</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
