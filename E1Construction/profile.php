...
<title>E-Construction | My Profile</title>
<!--Bootstrap -->
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="mobilenumber" value="<?php echo htmlentities($result->ContactNo);?>" id="phone-number" type="text" required maxlength="10" pattern="[0-9]+">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Your Address<span> * </span></label>
              <textarea class="form-control white_bg" name="address" rows="4" required=""><?php echo htmlentities($result->Address);?></textarea>
            </div>
            <div class="form-group">
