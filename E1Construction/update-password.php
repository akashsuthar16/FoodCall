...
<title>E-Construction - Update Password</title>
<!--Bootstrap -->
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="newpassword" type="password" name="newpassword" required minlength="8">
            </div>
            <div class="form-group">
              <label class="control-label">Confirm Password</label>
              <input class="form-control white_bg" id="confirmpassword" type="password" name="confirmpassword"  required minlength="8">
            </div>
