...
<head>
    ...
    <title>Food Call Admin | Add User</title>
    <!-- Bootstrap Core CSS -->
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="fname" class="form-control form-control-danger" placeholder="First-Name" required="">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="email" class="form-control form-control-danger" placeholder="example@gmail.com" required="">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
										 ...
										 <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control form-control-danger" placeholder="password" required="">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control form-control-danger" maxlength="10" pattern="[0-9]+" required="" placeholder="phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
