...
<head>
    ...
    <title>Food Call Admin | All Orders</title>
    <!-- Bootstrap Core CSS -->
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			{
																			?>
																			<td> <button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars"  aria-hidden="true" > Orderd</button></td>
																		   <?php 
																			  }
