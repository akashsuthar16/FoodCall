...
<head>
    ...
    <title>Food Call Admin | All Restraunt</title>
    <!-- Bootstrap Core CSS -->
																				...
																				$mql="SELECT * FROM res_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr><td>'.$row['c_name'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 ...
																									 <a href="update_restraunt.php?res_upd='.$rows['rs_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
