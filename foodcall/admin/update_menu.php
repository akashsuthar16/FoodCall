...
<head>
    ...
    <title>Food Call Admin | Update Menu</title>
    <!-- Bootstrap Core CSS -->
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" value="<?php echo $roww['slogan'];?>" class="form-control form-control-danger" placeholder="Details">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
