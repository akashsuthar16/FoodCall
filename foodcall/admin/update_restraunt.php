...
<head>
    ...
    <title>Food Call Admin | Update Restruant</title>
    <!-- Bootstrap Core CSS -->
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="(+91) 99999 99999" pattern="[0-9]+" maxlength="10">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
