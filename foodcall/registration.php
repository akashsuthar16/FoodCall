...
<head>
    ...
    <title>Food Call | Register</title>
    <!-- Bootstrap core CSS -->
         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/FooD.png" alt="" style="height: 40px"> </a>
               ...
               <div class="container">
                  <div class="row">
                        ...
                        <div class="widget">
                           <div class="widget-body">
							  ...
							  <form action="" method="post">
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder="Phone" maxlength="10" pattern="[0-9]+" required="" > <small class="form-text text-muted">We"ll never share your Contact Number with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputPassword1">Password <span style="color: red">*</span></label>
                                       <input type="password" class="form-control" name="password" id="exampleInputPassword1" placeholder="Password" minlength="6" required=""> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputPassword1">Confirm password <span style="color: red">*</span></label>
                                       <input type="password" class="form-control" name="cpassword" id="exampleInputPassword2" placeholder="Password" minlength="6" required=""> 
                                    </div>
									 <div class="form-group col-sm-12">
                                 ...
                                 <div class="cta">You have alreadys registered?<a href="login.php" style="color:#f30;"> Login an account</a></div>
                              </form>
                     ...
                     <div class="col-md-4">
                        ...
                        <p style="color: red">Once you"re registered, you can:</p>
                        <hr>
               ...
               <div class="container">
                  ...
                  <div class="row top-footer">
                     <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/FooD.png" alt="Footer logo" style="height: 50px"> </a> <span>Order Delivery &amp; Take-Out </span> 
                     </div>
